...
print find_grant_cap([2, 100, 50, 120, 1000], 190)
print find_grant_cap([2,4], 3)
print find_grant_cap([2,4,6], 3)
print find_grant_cap([2,100,50,120,1000], 190)
print find_grant_cap([2,100,50,120,167], 400)
print find_grant_cap([21,100,50,120,130,110], 140)
print find_grant_cap([210,200,150,193,130,110,209,342,117], 1530)

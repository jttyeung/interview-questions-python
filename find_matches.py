...
class FindMatches(object):
    ...
    def __init__(self, input_file, matching_type):
        ...
        with open(self.input_file, 'rU') as csv_file_in:
...
# def write_csv(header):
#     """ Returns a copy of the original csv with the unique identifier of the person each row represents prepended to the row. """
